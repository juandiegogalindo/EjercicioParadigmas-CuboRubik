...
public class PanelInferior extends JPanel {
    ...
    public PanelInferior(Rubik rubik) {
        this.rubik = rubik;
    ...
    public void actualizarColores() {
        removeAll(); 
        Color colorSubPanel1 = rubik.getCuborubik()[1][0][0].getInferior();
        Color colorSubPanel2 = rubik.getCuborubik()[1][1][0].getInferior();
        Color colorSubPanel3 = rubik.getCuborubik()[1][0][1].getInferior();
        Color colorSubPanel4 = rubik.getCuborubik()[1][1][1].getInferior();
