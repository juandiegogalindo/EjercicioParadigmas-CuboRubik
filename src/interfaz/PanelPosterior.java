 ...
 * @author SG701-12
 */
public class PanelPosterior extends JPanel {
    private Rubik rubik;
    private final Border border = BorderFactory.createLineBorder(Color.WHITE, 2);

    public PanelPosterior(Rubik rubik) {
        this.rubik = rubik;
    ...
    public void actualizarColores() {
        removeAll(); 
        Color colorSubPanel1 = rubik.getCuborubik()[0][1][1].getPosterior();
        Color colorSubPanel2 = rubik.getCuborubik()[0][0][1].getPosterior();
        Color colorSubPanel3 = rubik.getCuborubik()[1][1][1].getPosterior();
        Color colorSubPanel4 = rubik.getCuborubik()[1][0][1].getPosterior();
