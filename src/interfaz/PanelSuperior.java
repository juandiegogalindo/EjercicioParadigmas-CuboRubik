...
public class PanelSuperior extends JPanel {
    ...
    public PanelSuperior(Rubik rubik) {
        this.rubik = rubik;
    ...
    public void actualizarColores() {
        removeAll(); 
        Color colorSubPanel1 = rubik.getCuborubik()[0][0][1].getSuperior();
        Color colorSubPanel2 = rubik.getCuborubik()[0][1][1].getSuperior();
        Color colorSubPanel3 = rubik.getCuborubik()[0][0][0].getSuperior();
        Color colorSubPanel4 = rubik.getCuborubik()[0][1][0].getSuperior();
