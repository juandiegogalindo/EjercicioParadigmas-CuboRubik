...
public class PanelIzquierda extends JPanel {
    ...
    public PanelIzquierda(Rubik rubik) {
        this.rubik = rubik;
    ...
    public void actualizarColores() {
        removeAll(); 
        Color colorSubPanel1 = rubik.getCuborubik()[0][0][1].getIzquierdo();
        Color colorSubPanel2 = rubik.getCuborubik()[0][0][0].getIzquierdo();
        Color colorSubPanel3 = rubik.getCuborubik()[1][0][1].getIzquierdo();
        Color colorSubPanel4 = rubik.getCuborubik()[1][0][0].getIzquierdo();
